    ...
    return (
        <>
            <div className="social-card">
                <span>{n('social')}</span>
                <a className="social-link" href={n('instagram')} target='about:blank'>
                ...
                <a className="social-link" href={n('facebook')} target='about:blank'>
                ...
                <a className="social-link" href={n('mail')} target='about:blank'>
                ...
                <a className="social-link" href={n('whatsapp')} target='about:blank'>
